...
def create_input_files(dataset, json_path, image_folder, captions_per_image, min_word_freq, output_folder, max_len=100):
    ...
    base_filename = '_'.join([dataset,str(captions_per_image),'cap_per_img',str(min_word_freq),'min_word_freq'])
...
def clip_gradient(optimizer, grad_clip):
    """
    Clips gradient computed during backpropagation to avoid explosion of gradients
